...
!(function (e, t) {
            ...
            function e() {
                if (0 !== h.length) {
                    ...
                    if (M(o.before)) {
                        ...
                        if ("object" == typeof s) {
                            if ("abort" === s.action) return (e = "AbortError"), (t = n.file), (i = n.inputElem), (r = s.reason), void (M(o.error) && o.error({ name: e }, t, i, r));
    ...
    function u(e) {
        (this._handle = null),
            ...
            (this._sendError = function (e) {
                M(this._config.error) ? this._config.error(e) : o && this._config.error && f.postMessage({ workerId: b.WORKER_ID, error: e, finished: !1 });
            });
    }
    function l(e) {
        var r;
    ...
    function i(m) {
                ...
                (function () {
                    ...
                    function e(e, t) {
                        ...
                        return (
                            m.header &&
                                (i > l.length
                                    ? k("FieldMismatch", "TooManyFields", "Too many fields: expected " + l.length + " fields but parsed " + i, f + t)
                                    : i < l.length && k("FieldMismatch", "TooFewFields", "Too few fields: expected " + l.length + " fields but parsed " + i, f + t)),
                            r
                        );
                    }
                    var t = 1;
        ...
        (this.parse = function (e, t, i) {
            ...
            var s = w(m);
            return m.preview && m.header && s.preview++, (a = e), (o = new E(s)), (c = o.parse(a, t, i)), g(), d ? { meta: { paused: !0 } } : c || { meta: { paused: !1 } };
        }),
        ...
        (this.parse = function (r, t, i) {
            ...
            for (var p = r.indexOf(O, F), g = r.indexOf(x, F), _ = new RegExp(j(L) + j(S), "g"), m = r.indexOf(S, F); ; )
                if (r[F] !== S)
                    ...
                    for (m = F, F++; ; ) {
                        if (-1 === (m = r.indexOf(S, m + 1))) return i || u.push({ type: "Quotes", code: "MissingQuotes", message: "Quoted field unterminated", row: h.length, index: F }), E();
            ...
            function C(e) {
                return { data: h, errors: u, meta: { delimiter: O, linebreak: x, aborted: z, truncated: !!e, cursor: d + (t || 0) } };
            }
            function R() {
                T(C()), (h = []), (u = []);
            }
